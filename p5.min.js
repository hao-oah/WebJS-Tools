    ...
    return function a(b, c, d) {
        ...
        3: [function(a, b, c) {
            (function(b) {
                ...
                function t(a, b, c) {
                    var d = !1;
                    if (b |= 0, c = void 0 === c || c === 1 / 0 ? this.length : 0 | c, a || (a = "utf8"), b < 0 && (b = 0), c > this.length && (c = this.length), c <= b)
                        return "";
                    for (;;)
                        switch (a) {
                        case "hex":
                ...
                f.TYPED_ARRAY_SUPPORT = void 0 !== b.TYPED_ARRAY_SUPPORT ? b.TYPED_ARRAY_SUPPORT : d(), f.TYPED_ARRAY_SUPPORT ? (f.prototype.__proto__ = Uint8Array.prototype, f.__proto__ = Uint8Array) : (f.prototype.length = void 0, f.prototype.parent = void 0), f.isBuffer = function(a) {
                    ...
                    if (a === b)
                        return 0;
                    for (var c = a.length, d = b.length, e = 0, g = Math.min(c, d); e < g && a[e] === b[e];)
                        ++e;
                    ...
                    if (b > 2147483647 ? b = 2147483647 : b < -2147483648 && (b = -2147483648), b >>= 0, 0 === this.length)
                        return -1;
                    if (b >= this.length)
                        return -1;
                    if (b < 0 && (b = Math.max(this.length + b, 0)), "string" == typeof a)
                    ...
                    var f = this.length - b;
                    if ((void 0 === c || c > f) && (c = f), a.length > 0 && (c < 0 || b < 0) || b > this.length)
                ...
                !function(b, e) {
                    ...
                    function n() {
                        try {
                            var a = b,
                                c = a("vertx");
                            return w_w_w = c.runOnLoop || c.runOnContext, i()
                        } catch (a) {
                            return l()
                        }
                    }
                    ...
                    function G(a, b, d, e) {
                        var f = c(d),
                            ...
                            j = void 0;
                        if (f) {
                            if (g = F(d, e), g === ja ? (j = !0, h = g.error, g.error = null) : i = !0, b === g)
                                return void B(b, s())
                        } else
                            g = e, i = !0;
                ...
                !function(b, e) {
                    ...
                    function l(a, b, c) {
                        var d,
                            ...
                            i,
                            l;
                        for (d = j(a, 5, 257), e = j(a, 5, 1), f = j(a, 4, 4), g = 0; g < 19; ++g)
                            we[g] = 0;
                        for (g = 0; g < f; ++g) {
                            var m = j(a, 3, 0);
                            we[ue[g]] = m
                        ...
                        for (;;) {
                            ...
                            if (d < 256)
                                ...
                                var e,
                                    ...
                                    g,
                                    h;
                                for (d -= 257, e = j(a, qe[d], re[d]), f = k(a, c), g = a.destLen - j(a, se[f], te[f]), h = g; h < g + e; ++h)
                    ...
                    function S(a, b, c, d, e) {
                        ...
                        for (var g = new Ne.Parser(c, d + e + 14), h = new Ne.Parser(c, d + e + 16 + 2 * f), i = new Ne.Parser(c, d + e + 16 + 4 * f), j = new Ne.Parser(c, d + e + 16 + 6 * f), k = d + e + 16 + 8 * f, l = 0; l < f - 1; l += 1)
                            for (var m = void 0, n = g.parseUShort(), o = h.parseUShort(), p = i.parseShort(), q = j.parseUShort(), r = o; r <= n; r += 1)
                                0 !== q ? (k = j.offset + j.relativeOffset - 2, k += q, k += 2 * (r - o), 0 !== (m = Ne.getUShort(c, k)) && (m = m + p & 65535)) : m = r + p & 65535, a.glyphIndexMap[r] = m
                    }
                    function T(a, b) {
                        var c = {};
                        ...
                        if (c.format = h.parseUShort(), 12 === c.format)
                            R(c, h);
                        else {
                            if (4 !== c.format)
                                throw new Error("Only format 4 and 12 cmap tables are supported (found format " + c.format + ").");
                            S(c, h, a, b, d)
                        }
                        return c
                    }
                    ...
                    function $(a) {
                        ...
                        case 2:
                            ...
                            for (var c = 0; c < a.numberOfGlyphs; c++)
                                a.glyphNameIndex[c] < Se.length ? b.names[c] = Se[a.glyphNameIndex[c]] : b.names[c] = a.names[a.glyphNameIndex[c] - Se.length];
                            break;
                        case 2.5:
                            this.names = new Array(a.numberOfGlyphs);
                    ...
                    function ca(a, b, c) {
                        ...
                        if (a.numberOfContours > 0) {
                            ...
                            if (ze.argument(e.length === j, "Bad flags."), g.length > 0) {
                                ...
                                if (j > 0) {
                                    ...
                                    for (var q = 0, r = 0; r < j; r += 1)
                                        f = e[r], n = o[r], n.x = ba(d, f, q, 2, 16), q = n.x;
                                    for (var s = 0, t = 0; t < j; t += 1)
                                        f = e[t], n = o[t], n.y = ba(d, f, s, 4, 32), s = n.y
                                }
                                a.points = o
                            } else
                                a.points = []
                            ...
                            if (256 & e) {
                                a.instructionLength = d.parseUShort(), a.instructions = [];
                                for (var w_w_w = 0; w_w_w < a.instructionLength; w_w_w += 1)
                                    a.instructions.push(d.parseByte())
                            }
                        }
                    }
                    ...
                    function fa(a) {
                        ...
                        for (var c = ea(a), d = 0; d < c.length; ++d) {
                            ...
                            for (var j = 0; j < e.length; ++j)
                                if (f = g, g = h, h = e[(j + 1) % e.length], g.onCurve)
                                    b.lineTo(g.x, g.y);
                                else {
                                    var k = f,
                                        l = h;
                        ...
                        if (b.isComposite)
                            for (var c = 0; c < b.components.length; c += 1) {
                                ...
                                if (e.getPath(), e.points) {
                                    var f = void 0;
                                    if (void 0 === d.matchedPoints)
                                        f = da(e.points, d);
                                    else {
                                        if (d.matchedPoints[0] > b.points.length - 1 || d.matchedPoints[1] > e.points.length - 1)
                    ...
                    function ta(a, b) {
                        ...
                        if (29 === b)
                            return c = a.parseByte(), d = a.parseByte(), e = a.parseByte(), f = a.parseByte(), c << 24 | d << 16 | e << 8 | f;
                        if (30 === b)
                            return sa(a);
                        if (b >= 32 && b <= 246)
                            return b - 139;
                    ...
                    function ua(a) {
                        for (var b = {}, c = 0; c < a.length; c += 1) {
                            var d = a[c][0],
                                e = a[c][1],
                                f = void 0;
                            if (f = 1 === e.length ? e[0] : e, b.hasOwnProperty(d) && !isNaN(b[d]))
                        ...
                        for (var d, e = {}, f = 0; f < b.length; f += 1) {
                            ...
                            if (Array.isArray(g.type)) {
                                ...
                                for (var i = 0; i < g.type.length; i++)
                                    d = void 0 !== a[g.op] ? a[g.op][i] : void 0, void 0 === d && (d = void 0 !== g.value && void 0 !== g.value[i] ? g.value[i] : null), "SID" === g.type[i] && (d = wa(c, d)), h[i] = d;
                                e[g.name] = h
                            } else
                                d = a[g.op], void 0 === d && (d = void 0 !== g.value ? g.value : null), "SID" === g.type && (d = wa(c, d)), e[g.name] = d
                        }
                        return e
                    }
                    function ya(a, b) {
                    ...
                    function Ca(a, b, c, d) {
                        ...
                        if (0 === i)
                            ...
                            if (2 !== i)
                                throw new Error("Unknown charset format " + i);
                            for (; h.length <= c;) {
                    ...
                    function Da(a, b, c) {
                        ...
                        if (0 === g)
                            ...
                            if (1 !== g)
                                throw new Error("Unknown encoding format " + g);
                            var j = f.parseCard8();
                            d = 1;
                            for (var k = 0; k < j; k += 1)
                        ...
                        function f(c) {
                            for (var m, r, w, x, z, A, B, C, D, E, F, G, H = 0; H < c.length;) {
                                ...
                                case 31:
                                    ...
                                    break;
                                default:
                                    I < 32 ? console.log("Glyph " + b.index + ": unknown operator " + I) : I < 247 ? p.push(I - 139) : I < 251 ? (m = c[H], H += 1, p.push(256 * (I - 247) + m + 108)) : I < 255 ? (m = c[H], H += 1, p.push(256 * -(I - 251) - m - 108)) : (m = c[H], r = c[H + 1], w_w_w = c[H + 2], x = c[H + 3], H += 4, p.push((m << 24 | r << 16 | w_w_w << 8 | x) / 65536))
                                }
                            }
                        }
                        var g,
                            ...
                            v = 0;
                        if (a.isCIDFont) {
                            var w_w_w = a.tables.cff.topDict._fdSelect[b.index],
                                x = a.tables.cff.topDict._fdArray[w];
                            k = x._subrs, l = x._subrsBias, m = x._defaultWidthX, n = x._nominalWidthX
                        } else
                            k = a.tables.cff.topDict._subrs, l = a.tables.cff.topDict._subrsBias, m = a.tables.cff.topDict._defaultWidthX, n = a.tables.cff.topDict._nominalWidthX;
                        var y = m;
                    ...
                    function Fa(a, b, c, d) {
                        ...
                        if (0 === h)
                            for (var i = 0; i < c; i++) {
                                if ((e = g.parseCard8()) >= d)
                                    throw new Error("CFF table CID Font FDSelect has bad FD index value " + e + " (FD count " + d + ")");
                                f.push(e)
                            }
                        else {
                            if (3 !== h)
                                throw new Error("CFF Table CID Font FDSelect table has unsupported format " + h);
                            var j = g.parseCard16(),
                                k = g.parseCard16();
                            if (0 !== k)
                                throw new Error("CFF Table CID Font FDSelect format 3 range has bad initial GID " + k);
                            for (var l, m = 0; m < j; m++) {
                    ...
                    function Ga(a, b, c) {
                        ...
                        if (1 !== i.length)
                            throw new Error("CFF table has too many fonts in 'FontSet' - count of fonts NameIndex.length = " + i.length);
                        var j = i[0];
                    ...
                    function jb(a, b) {
                        ...
                        for (var g in a) {
                            ...
                            if (void 0 === h && (h = g), c = parseInt(h), isNaN(c))
                                throw new Error('Name table entry "' + g + '" does not exist, see nameTableNames for complete list.');
                            e[c] = a[g], d.push(c)
                        }
                    ...
                    function wb(a) {
                        ...
                        for (var d = [], e = [], f = b.sizeOf() + vb().sizeOf() * b.numTables; f % 4 != 0;)
                            f += 1, e.push({
                                name: "padding",
                                type: "BYTE",
                                value: 0
                        ...
                        for (var g = 0; g < a.length; g += 1) {
                            ...
                            for (d.push({
                                ...
                                type: "RECORD",
                                value: h
                            }), f += i, ze.argument(!isNaN(f), "Something went wrong calculating the offset."); f % 4 != 0;)
                                f += 1, e.push({
                                    name: "padding",
                                    type: "BYTE",
                                    value: 0
                    ...
                    function zb(a) {
                        for (var b, c = [], d = [], e = [], f = [], g = [], h = [], i = [], j = 0, k = 0, l = 0, m = 0, n = 0, o = 0; o < a.glyphs.length; o += 1) {
                            ...
                            if (isNaN(p.advanceWidth))
                                throw new Error("Glyph " + p.name + " (" + o + "): advanceWidth is not a number.");
                    ...
                    function zc(b) {
                        ...
                        b.prog = b.funcs[d];
                        for (var h = 0; h < e; h++)
                            vf(b), a.DEBUG && console.log(++b.step, h + 1 < e ? "next loopcall" : "done loopcall", h);
                        b.ip = f, b.prog = g
                    }
                    function Ac(b) {
                        var c = b.stack.pop();
                    ...
                    function Ic(b, c) {
                        ...
                        for (var k, l = h.distance(f, f, !1, !0), m = j.length - 2, n = 0; n < m; n++)
                    ...
                    function Vd(a, b, c) {
                        ...
                        d.skip("uShort", 1);
                        for (var g = d.parseUShort(), h = d.parseUShort(), i = d.parseUShort(), j = d.parseUShort(), k = [], l = 0; l < g; l++)
                    ...
                    function Wd(a, b) {
                        for (var c = new Ne.Parser(a, b), d = c.parseUShort(), e = [], f = 0; f < d; f++)
                            e[c.parseTag()] = {
                    ...
                    function Yd(a, b) {
                        ...
                        if (2 === d) {
                            for (var h = c.parseUShort(), i = [], j = [], k = [], l = 0; l < h; l++)
                                i[l] = c.parseUShort(), j[l] = c.parseUShort(), k[l] = c.parseUShort();
                            return function(a) {
                    ...
                    function Zd(a, b) {
                        ...
                        if (4 === h && 0 === i) {
                            ...
                            if (2 === e) {
                                for (var s = d.parseUShort(), t = d.parseUShort(), u = d.parseUShort(), v = d.parseUShort(), w_w_w = Yd(a, b + s), x = Yd(a, b + t), y = [], z = 0; z < u; z++)
                                    for (var A = y[z] = [], B = 0; B < v; B++)
                                        h && (c = d.parseShort()), i && d.parseShort(), A[B] = c;
                    ...
                    function ie(a, b) {
                        if ("WOFF" === b.compression) {
                            ...
                            if (ye(c, d), d.byteLength !== b.length)
                                throw new Error("Decompression error: " + b.tag + " decompressed length doesn't match recorded length");
                            return {
                    ...
                    function je(a) {
                        var b,
                            ...
                            g = [],
                            h = Ne.getTag(f, 0);
                        if (h === String.fromCharCode(0, 1, 0, 0) || "true" === h || "typ1" === h)
                            e.outlinesFormat = "truetype", d = Ne.getUShort(f, 4), g = ge(f, d);
                        else if ("OTTO" === h)
                            e.outlinesFormat = "cff", d = Ne.getUShort(f, 4), g = ge(f, d);
                        else {
                            if ("wOFF" !== h)
                        ...
                        for (var j, k, l, m, n, o, p, q, r, s, t, u = 0; u < d; u += 1) {
                            ...
                            switch (v.tag) {
                            case "cmap":
                                w_w_w = ie(f, v), e.tables.cmap = Oe.parse(w.data, w.offset), e.encoding = new Y(e.tables.cmap);
                                break;
                            case "cvt ":
                                w_w_w = ie(f, v), t = new Ne.Parser(w.data, w.offset), e.tables.cvt = t.parseShortList(v.length / 2);
                                break;
                            case "fvar":
                                k = v;
                                break;
                            case "fpgm":
                                w_w_w = ie(f, v), t = new Ne.Parser(w.data, w.offset), e.tables.fpgm = t.parseByteList(v.length);
                                break;
                            case "head":
                                w_w_w = ie(f, v), e.tables.head = Ze.parse(w.data, w.offset), e.unitsPerEm = e.tables.head.unitsPerEm, b = e.tables.head.indexToLocFormat;
                                break;
                            case "hhea":
                                w_w_w = ie(f, v), e.tables.hhea = $e.parse(w.data, w.offset), e.ascender = e.tables.hhea.ascender, e.descender = e.tables.hhea.descender, e.numberOfHMetrics = e.tables.hhea.numberOfHMetrics;
                                break;
                            case "hmtx":
                                o = v;
                                break;
                            case "ltag":
                                w_w_w = ie(f, v), c = af.parse(w.data, w.offset);
                                break;
                            case "maxp":
                                w_w_w = ie(f, v), e.tables.maxp = bf.parse(w.data, w.offset), e.numGlyphs = e.tables.maxp.numGlyphs;
                                break;
                            case "name":
                                r = v;
                                break;
                            case "OS/2":
                                w_w_w = ie(f, v), e.tables.os2 = mf.parse(w.data, w.offset);
                                break;
                            case "post":
                                w_w_w = ie(f, v), e.tables.post = nf.parse(w.data, w.offset), e.glyphNames = new $(e.tables.post);
                                break;
                            case "prep":
                                w_w_w = ie(f, v), t = new Ne.Parser(w.data, w.offset), e.tables.prep = t.parseByteList(v.length);
                                break;
                            case "glyf":
                                l = v;
                                break;
                    ...
                    De.MACSTRING = function(a, b) {
                        ...
                        if (Array.isArray(b))
                            for (var d = 0; d < b.length; d += 1)
                                ze.argument(a.length === b.length, "Not enough arguments given for type" + b), c = c.concat(De.OPERAND(a[d], b[d]));
                        else if ("SID" === b)
                            c = c.concat(De.NUMBER(a));
                        else if ("offset" === b)
                            c = c.concat(De.NUMBER32(a));
                        else if ("number" === b)
                            c = c.concat(De.NUMBER(a));
                        else {
                            if ("real" !== b)
                    ...
                    ja.prototype.bindConstructorValues = function(a) {
                        ...
                        var h = d.xScale,
                            i = d.yScale;
                        if (d.hinting && e && e.hinting && (g = this.path && e.hinting.exec(this, c)), g)
                            f = Ue.getPath(g).commands, a = Math.round(a), b = Math.round(b), h = i = 1;
                        else {
                    ...
                    Cb.prototype = {
                        ...
                        getLangSysTable: function(a, b, c) {
                            ...
                            if (d) {
                                ...
                                if (e >= 0)
                                    return d.langSysRecords[e].langSys;
                                if (c) {
                                    var f = {
                                        tag: b,
                                        langSys: {
                        ...
                        if (j >= 0) {
                            for (var k = f.ligatureSets[j], l = 0; l < k.length; l++)
                                if (Eb(k[l].components, h))
                                    return;
                            k.push(i)
                        } else
                            j = -1 - j, f.coverage.glyphs.splice(j, 0, g), f.ligatureSets.splice(j, 0, [i])
                    }, Db.prototype.getFeature = function(a, b, c) {
                        if (/ss\d\d/.test(a))
                            return this.getSingle(a, b, c);
                        switch (a) {
                        case "aalt":
                        case "salt":
                    ...
                    Object.freeze(zf), Object.freeze(Af), Rb.prototype.distance = function(a, b, c, d) {
                        ...
                        var e,
                            ...
                            j,
                            k;
                        if (g = d.distance(a, b, !0, !0), h = d.distance(a, c, !0, !0), e = d.distance(b, b, !1, !0), f = d.distance(c, c, !1, !0), i = Math.abs(g), j = Math.abs(h), 0 === (k = i + j))
                    ...
                    Kb.prototype.exec = function(b, c) {
                        ...
                        if (!(this._errorState > 2)) {
                            ...
                            if (!e || e.ppem !== c) {
                                ...
                                var g = d.tables.cvt;
                                if (g)
                                    for (var h = e.cvt = new Array(g.length), i = c / d.unitsPerEm, j = 0; j < g.length; j++)
                                        h[j] = g[j] * i;
                                else
                                    e.cvt = [];
                        ...
                        if (Ub.prototype = c, i) {
                            ...
                            f = new Ub("glyf", b.instructions), a.DEBUG && (console.log("---EXEC GLYPH---"), f.step = -1), xf(b, f, g, h), e = f.gZone;
                        return e
                    }, xf = function(b, c, d, e) {
                        for (var f, g = b.points || [], h = g.length, i = c.gZone = c.z0 = c.z1 = c.z2 = [], j = c.contours = [], k = 0; k < h; k++)
                            f = g[k], i[k] = new Tb(f.x * d, f.y * e, f.lastPointOfContour, f.onCurve);
                        ...
                        if (c) {
                            ...
                            for (b.ip = 0; b.ip < e; b.ip++) {
                                if (a.DEBUG && b.step++, !(d = uf[c[b.ip]]))
                                    throw new Error("unknown instruction: 0x" + Number(c[b.ip]).toString(16));
                                d(b)
                            }
                        }
                        ...
                        if (b.features) {
                            ...
                            for (var j = 0; j < g; j += 1)
                                for (var k = 0; k < i.length; k++) {
                                    for (var l = i[k], m = l.sub, n = m.length, o = 0; o < n && m[o] === d[j + o];)
                                        o++;
                                    o === n && (d.splice(j, n, l.by), g = g - n + 1)
                                }
                        }
                        for (var p = new Array(g), q = this.glyphs.get(0), r = 0; r < g; r += 1)
        ...
        14: [function(a, b, c) {
            ...
            a("./p5.Color"), a("../core/error_helpers"), d.prototype.alpha = function(a) {
                ...
                if (d._validateParameters("color", arguments), arguments[0] instanceof d.Color)
                    return arguments[0];
                ...
                if (l === e.RGB)
                    ...
                    a._getBrightness(), b._getBrightness(), j = a.hsba, k = b.hsba;
                else {
                    if (l !== e.HSL)
        ...
        15: [function(a, b, c) {
            ...
            d.Color = function(a, b) {
                if (this._storeModeAndMaxes(a._colorMode, a._colorMaxes), this.mode !== e.RGB && this.mode !== e.HSL && this.mode !== e.HSB)
            ...
            d.Color._parseInputs = function(a, b, c, h) {
                ...
                if (1 === i && "string" == typeof a) {
                    ...
                    if (g[n])
                        return d.Color._parseInputs.call(this, g[n]);
                    if (l.HEX3.test(n))
        ...
        17: [function(a, b, c) {
            ...
            a("./error_helpers"), d.prototype.arc = function(a, b, c, f, g, h, i) {
                if (d._validateParameters("arc", arguments), !this._renderer._doStroke && !this._renderer._doFill)
                    return this;
                for (this._angleMode === e.DEGREES && (g = this.radians(g), h = this.radians(h)); g < 0;)
                    g += e.TWO_PI;
                for (; h < 0;)
                    h += e.TWO_PI;
        ...
        23: [function(a, b, c) {
            ...
            h.prototype.print = function(a) {
                ...
                if (h._validateParameters("fullscreen", arguments), void 0 === a)
                    return document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement || document.msFullscreenElement;
                a ? f(document.documentElement) : g()
            }, h.prototype.pixelDensity = function(a) {
                if (h._validateParameters("pixelDensity", arguments), "number" != typeof a)
                ...
                h = function(a, b) {
                    b || (b = console.log.bind(console)), e || g(), e.some(function(c) {
                        if (a.message && null !== a.message.match("\\W?" + c.name + "\\W"))
                            return b("Did you just try to use p5.js's " + c.name + ("function" === c.type ? "() " : " ") + c.type + "? If so, you may want to move it into your sketch's setup() function.\n\nFor more details, see: " + f), !0
                    })
                };
        ...
        30: [function(a, b, c) {
            ...
            d.prototype.createCanvas = function(a, b, c) {
                ...
                if (h === e.WEBGL) {
                	...
                	// This line is modied to suit the need to display certain screen on post: KEYWORD : Screen_Display
                    g = document.createElement("canvas");
                    for (var j = 0; document.getElementById("defaultCanvas" + j);)
                        j++;
                    f = "defaultCanvas" + j, g.id = f
                    if (j==0) {
                    	if (typeof document.getElementById('Screen_Display') == "node")
                    		document.getElementById('Screen_Display').appendChild(document.getElementById('defaultCanvas0')); // temp solution
                	}
                }
                ...
                if (d._validateParameters("blendMode", arguments), a !== e.BLEND && a !== e.DARKEST && a !== e.LIGHTEST && a !== e.DIFFERENCE && a !== e.MULTIPLY && a !== e.EXCLUSION && a !== e.SCREEN && a !== e.REPLACE && a !== e.OVERLAY && a !== e.HARD_LIGHT && a !== e.SOFT_LIGHT && a !== e.DODGE && a !== e.BURN && a !== e.ADD && a !== e.NORMAL)
            ...
            e.prototype.exit = function() {
                ...
                if ("function" == typeof d) {
                    ...
                    for (var e = this, f = function(a) {
                        ...
                        this._setProperty("frameCount", this.frameCount + 1), this._registeredMethods.pre.forEach(f), d(), this._registeredMethods.post.forEach(f)
                }
        ...
        33: [function(a, b, c) {
            ...
            d.prototype.applyMatrix = function(a, b, c, d, e, f) {
                ...
                if (d._validateParameters("rotateX", arguments), !this._renderer.isP3D)
                    throw "not supported in p2d. Please use webgl mode";
                return this._renderer.rotateX(a), this
            }, d.prototype.rotateY = function(a) {
                if (d._validateParameters("rotateY", arguments), !this._renderer.isP3D)
                    throw "not supported in p2d. Please use webgl mode";
                return this._renderer.rotateY(a), this
            }, d.prototype.rotateZ = function(a) {
                if (d._validateParameters("rotateZ", arguments), !this._renderer.isP3D)
                    throw "not supported in p2d. Please use webgl mode";
        ...
        34: [function(a, b, c) {
            ...
            d.prototype.beginContour = function() {
                ...
                if (d._validateParameters("bezierVertex", arguments), 0 === g.length)
        ...
        35: [function(a, b, c) {
            ...
            d.TypedDict.prototype.size = function() {
                ...
                for (var b = Object.keys(this.data)[0], c = 1; c < Object.keys(this.data).length; c++)
        ...
        40: [function(a, b, c) {
            ...
            function e(a, b) {
                ...
                for (C = 0, v = -g, w_w_w = v * e, E = 0; E < k; E++) {
                    for (D = 0; D < e; D++) {
                        if (r = q = p = s = o = 0, v < 0)
                            x = u = -v, t = D;
                        else {
            ...
            f._toPixels = function(a) {
                ...
                for (var b, c, d, e, g, h, i, j, k, l, m, n, o, p, q, r, s, t = f._toPixels(a), u = 0, v = t.length ? t.length / 4 : 0, w_w_w = new Int32Array(v); u < v;)
        ...
        42: [function(a, b, c) {
            ...
            a("../core/error_helpers"), e.prototype.loadImage = function(a, b, c) {
                ...
                u = d(u, m), v = d(v, n);
                var w_w_w = 1;
                a.elt && !a.canvas && a.elt.style.width && (w = a.elt.videoWidth && !f ? a.elt.videoWidth : a.elt.width, w_w_w /= parseInt(a.elt.style.width, 10)), s *= w, t *= w, v *= w, u *= w;
            ...
            a("../core/error_helpers"), h.prototype.loadJSON = function() {
                ...
                for (var k = 1; k < arguments.length; k++)
                    if ("function" == typeof arguments[k])
                        void 0 === b ? b = arguments[k] : void 0 === c && (c = arguments[k]);
                ...
                return this.httpDo(a, "GET", "text", function(a) {
                    for (var c, e = {}, g = 0, j = 1, n = 2, o = 4, p = '"', q = "\r", r = "\n", s = [], t = 0, u = null, v = function() {
                        ...
                        if (e.currentState === j && e.escaped)
                            if (c === p)
                                a[t] === p ? (e.token += p, t++) : (e.escaped = !1, e.currentState = n);
                            else {
                                if (c === q)
                                    continue;
                                e.token += c
                            ...
                            c === q ? (a[t] === r && t++, w(), y()) : c === r ? (w(), y()) : c === i ? w() : e.currentState === j && (e.token += c)
                    }
                    if (f)
                        l.columns = s.shift();
                    else
                    ...
                    for (k = 0; k < s.length; k++)
                        (1 !== s[k].length || "undefined" !== s[k][0] && "" !== s[k][0]) && (z = new h.TableRow, z.arr = s[k], z.obj = d(s[k], l.columns), l.addRow(z));
                ...
                if (2 == arguments.length - f && "string" == typeof arguments[0] && "object" == typeof arguments[1])
                    c = new Request(arguments[0], arguments[1]), a = arguments[2], b = arguments[3], "" === d && (d = -1 !== c.url.indexOf("json") ? "json" : -1 !== c.url.indexOf("xml") ? "xml" : "text");
                else {
                    for (var j, k = arguments[0], l = "GET", m = 1; m < arguments.length; m++) {
                        var n = arguments[m];
                        if ("string" == typeof n)
                            "GET" === n || "POST" === n || "PUT" === n || "DELETE" === n ? l = n : "json" === n || "jsonp" === n || "xml" === n || "text" === n ? d = n : j = n;
                            ...
                            if (n.hasOwnProperty("jsonpCallback"))
                                ...
                                j = JSON.stringify(n), g = "application/json";
                        else
        ...
        47: [function(a, b, c) {
            ...
            d.TableRow = function(a, b) {
                ...
                var b;
                if (b = "string" == typeof a ? parseFloat(this.obj[a]) : parseFloat(this.arr[a]), "NaN" === b.toString())
        ...
        51: [function(a, b, c) {
            ...
            e.prototype.noise = function(a, b, c) {
                ...
                for (var n, o, p, q, r, s = Math.floor(a), t = Math.floor(b), u = Math.floor(c), v = a - s, w_w_w = b - t, x = c - u, y = 0, z = .5, A = 0; A < k; A++) {
                    var B = s + (t << f) + (u << h);
                    n = m(v), o = m(w), p = d[B & j], p += n * (d[B + 1 & j] - p), q = d[B + g & j], q += n * (d[B + g + 1 & j] - q), p += o * (q - p), B += i, q = d[B & j], q += n * (d[B + 1 & j] - q), r = d[B + g & j], r += n * (d[B + g + 1 & j] - r), q += o * (r - q), p += m(x) * (q - p), y += p * z, z *= l, s <<= 1, v *= 2, t <<= 1, w_w_w *= 2, u <<= 1, x *= 2, v >= 1 && (s++, v--), w_w_w >= 1 && (t++, w--), x >= 1 && (u++, x--)
                }
                return y
        ...
        57: [function(a, b, c) {
            ...
            a("../core/error_helpers"), d.prototype.loadFont = function(a, b, c) {
                ...
                return f.load(a, function(f, h) {
                    if (f)
                        return void 0 !== c ? c(f) : (d._friendlyFileLoadError(4, a), void console.error(f, a));
        ...
        58: [function(a, b, c) {
            ...
            function q(a, b, c, d, e, f, g, h, i, j) {
                ...
                if (j)
                    ...
                    var v = (a - h) / 2,
                        w_w_w = (b - i) / 2,
                        x = v * v / (c * c) + w_w_w * w_w_w / (d * d);
                    x > 1 && (x = Math.sqrt(x), c *= x, d *= x);
                    var y = c * c,
                        z = d * d,
                        A = (f === g ? -1 : 1) * Math.sqrt(Math.abs((y * z - y * w_w_w * w_w_w - z * v * v) / (y * w_w_w * w_w_w + z * v * v)));
                    m = A * c * w_w_w / d + (a + h) / 2, n = A * -d * v / c + (b + i) / 2, k = Math.asin(((b - n) / d).toFixed(9)), l = Math.asin(((i - n) / d).toFixed(9)), k = a < m ? p - k : k, l = h < m ? p - l : l, k < 0 && (k = 2 * p + k), l < 0 && (l = 2 * p + l), g && k > l && (k -= 2 * p), !g && l > k && (l -= 2 * p)
                }
                var B = l - k;
                if (Math.abs(B) > r) {
                    var C = l,
        ...
        61: [function(a, b, c) {
            ...
            function e(a, b) {
                ...
                if (e = e.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","), 0 === b)
                    d = "";
                else if (void 0 !== b)
                    if (b > d.length) {
                        d += -1 === c ? "." : "";
                        for (var f = b - d.length + 1, g = 0; g < f; g++)
                            d += "0"
                    } else
                        d = d.substring(0, b + 1);
                return e + d
        ...
        69: [function(a, b, c) {
            ...
            "undefined" != typeof Float32Array && (g = Float32Array, h = function(a) {
                ...
                var t = b * i - c * g,
                    ...
                    D = m * s - o * q,
                    E = n * s - o * r,
                    F = t * E - u * D + v * C + w_w_w * B - x * A + y * z;
                return F ? (F = 1 / F, this.mat4[0] = (i * E - j * D + k * C) * F, this.mat4[1] = (e * D - c * E - f * C) * F, this.mat4[2] = (q * y - r * x + s * w) * F, this.mat4[3] = (n * x - m * y - o * w) * F, this.mat4[4] = (j * B - g * E - k * A) * F, this.mat4[5] = (b * E - e * B + f * A) * F, this.mat4[6] = (r * v - p * y - s * u) * F, this.mat4[7] = (l * y - n * v + o * u) * F, this.mat4[8] = (g * D - i * B + k * z) * F, this.mat4[9] = (c * B - b * D - f * z) * F, this.mat4[10] = (p * x - q * v + s * t) * F, this.mat4[11] = (m * v - l * x - o * t) * F, this.mat4[12] = (i * A - g * C - j * z) * F, this.mat4[13] = (b * C - c * A + e * z) * F, this.mat4[14] = (q * u - p * w_w_w - r * t) * F, this.mat4[15] = (l * w_w_w - m * u + n * t) * F, this) : null
                ...
                var b;
                if (a === this || a === this.mat4)
                    b = this.copy().mat4;
                else if (a instanceof d.Matrix)
                    b = a.mat4;
                else {
                    if (!h(a))
                        return;
        ...
        72: [function(a, b, c) {
            ...
            d.RendererGL = function(a, b, c, e) {
                ...
                try {
                    if (this.drawingContext = this.canvas.getContext("webgl", this.attributes) || this.canvas.getContext("experimental-webgl", this.attributes), null === this.drawingContext)
                ...
                if (!0 !== this.attributes.preserveDrawingBuffer)
                    return void console.log("loadPixels only works in WebGL when preserveDrawingBuffer is true.");
        ...
        73: [function(a, b, c) {
            ...
            d.Shader = function(a, b, c) {
                ...
                if (0 === this._glProgram) {
                    ...
                    if (this._vertShader = a.createShader(a.VERTEX_SHADER), a.shaderSource(this._vertShader, this._vertSrc), a.compileShader(this._vertShader), !a.getShaderParameter(this._vertShader, a.COMPILE_STATUS))
                        return console.error("Yikes! An error occurred compiling the vertex shader:" + a.getShaderInfoLog(this._vertShader)), null;
                    if (this._fragShader = a.createShader(a.FRAGMENT_SHADER), a.shaderSource(this._fragShader, this._fragSrc), a.compileShader(this._fragShader), !a.getShaderParameter(this._fragShader, a.COMPILE_STATUS))
                        return console.error("Darn! An error occurred compiling the fragment shader:" + a.getShaderInfoLog(this._fragShader)), null;
        ...
        74: [function(a, b, c) {
            ...
            d.Texture = function(a, b) {
                ...
                if (this.glTex = b.createTexture(), this.bindTexture(), b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MAG_FILTER, this.glMagFilter), b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MIN_FILTER, this.glMinFilter), b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_S, this.glWrapS), b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_T, this.glWrapT), 0 === this.width || 0 === this.height || this.isSrcMediaElement && !this.src.loadedmetadata) {
                    ...
                    b.texImage2D(this.glTarget, 0, this.glFormat, this.glFormat, b.UNSIGNED_BYTE, a)
                ...
                if (0 !== a.width && 0 !== a.height) {
                    ...
                    if (b.width !== this.width || b.height !== this.height)
                        this.width = b.width, this.height = b.height, this.bindTexture(), c.texImage2D(this.glTarget, 0, this.glFormat, this.glFormat, c.UNSIGNED_BYTE, b), this.isSrcP5Image ? a.setModified(!1) : (this.isSrcMediaElement || this.isSrcHTMLElement) && a.setModified(!0);
                    else if (this.isSrcP5Image)
                        a.isModified() && (this.bindTexture(), c.texImage2D(this.glTarget, 0, this.glFormat, this.glFormat, c.UNSIGNED_BYTE, b), a.setModified(!1));
                        ...
                        c.texImage2D(this.glTarget, 0, this.glFormat, this.glFormat, c.UNSIGNED_BYTE, b)
                }
        ...
        75: [function(a, b, c) {
            ...
            var e = function(a, b, c, e, f, g, h) {
                ...
                for (i = n; i <= o; ++i) {
                    var p,
                        q = i / f,
                        r = c * q;
                    for (i < 0 ? (r = 0, q = 1, p = a) : i > f ? (r = c, q = 1, p = b) : p = a + i / f * (b - a), -2 !== i && i !== f + 2 || (p = 0, q = 0), r -= c / 2, j = 0; j < l; ++j)
            ...
            d.prototype.cylinder = function(a, b, c, f) {
                ...
                if (!this.geometryInHash(j)) {
                    ...
                    l.computeNormals()._makeTriangleEdges(), this._edgesToVertices(l), l.faces = [[0, 1, 2], [2, 3, 0]], this.createBuffers(j, l)
                }
